...
let userName1 = "Irfan Khan"
console.log(`Your name in Lowercase is ${userName1.toLowerCase()}`)
console.log(`Your name in Uppercase is ${userName1.toUpperCase()}`)
console.log(`Your name in Titlecase is ${userName1}`)
...
let nameWithWhiteSpace = "   Kashan Malik   "
console.log(`Your name with Whitespace ${nameWithWhiteSpace}`)
let nameWithStriping = nameWithWhiteSpace.trim()
console.log(`Your name with after striping ${nameWithStriping}`)
...
console.log(`8 Number Addition is ${5 + 3}`)
console.log(`8 Number Subtraction is ${10 - 2}`)
console.log(`8 Number Multiplication is ${2 * 4}`)
console.log(`8 Number Division is ${16 / 2}`)
...
let friendsName = ["Hashir", "Tayyab", "Suleman", "Jawad"]
for (let i = 0; i < friendsName.length; i++) {
    console.log(`My Friend Number ${i + 1} is ${friendsName[i]}`)
}
...
for (let i = 0; i < friendsName.length; i++) {
    console.log(`Assalam O Alaikum ${friendsName[i]}! Good Morning`)
}
...
let cars = ["Sportage", "Fortuner", "Land Cruiser"]
...
let guests = ["Kashan Malik", "Hashir", "Tayyab Faiz"]
...
guests = [];
console.log(`\nFinal Guest List is ${guests}`)

// 16) Seeing the World: Think of at least five places in the world you’d like to visit.
// • Store the locations in a array. Make sure the array is not in alphabetical order.
let placesToVisit = ["London", "Dubai", "Canada", "England"]

// • Print your array in its original order.
console.log(`Original Order is ${placesToVisit}`)

// • Print your array in alphabetical order without modifying the actual list.
console.log(`Alphabetical Order is ${[placesToVisit].sort()}`)

// • Show that your array is still in its original order by printing it.
console.log(`Original Orderis ${placesToVisit}`)

// • Print your array in reverse alphabetical order without changing the order of the original list.
console.log(`Reverse Alphabetical Order is ${[placesToVisit].sort().reverse()}`)
...
console.log(`Reversed Order is ${placesToVisit}`)
...
placesToVisit.sort()
console.log(`Sorted in Alphabetical Order is ${placesToVisit}`)

// • Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order has changed.
placesToVisit.sort((a, b) => b.localeCompare(a))
console.log(`Sorted in Reverse Alphabetical Order is ${placesToVisit}`)
...
let guest = ["Kashan Malik", "Aaliyan", "Owais", "Jawad Ahmed", "Hashir"]
...
let programminglang = ["Typescript", "Python", "Next JS", "Tailwind CSS", "Dart", "Flutter"]
...
const item1 = createItem("Book", 2, 10.99)
const item2 = createItem("Pen", 5, 1.5)
const item3 = createItem("Notebook", 3, 4.99)
...
const studentName = ["Kashan Malik", "Hashir", "Jawad Ahmed", "Tayyab Faiz"]
...
let current_users = ["kashan", "malik", "awan", "jawad"]
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let new_users = ["Kashan", "Malik", "Hashir", "Suleman"]
...
let city2 = city_country("Lohare", "Pakistan")
...
function make_great1(magicianName) {
    let newMagicians = [""]
    for(let i = 0; i < magicianName.length; i++) {
        newMagicians.push(`The Great ${magicianName[i]}`)
    }
    return newMagicians
}
let greatMagicians = make_great1(magicianName.slice())
...
let myCar = carInfo('Honda', 'Civic', 'color', 'Blue', 'year', 2023)
console.log(myCar)
